                ...
                <div className="flex flex-wrap gap-2 md:gap-3">
                  {technologies.split(", ").map((tech, index) => {
                    ...
                    return (
                      <span
                        key={index}
                        className={`px-2.5 sm:px-3 md:px-4 py-1.5 md:py-2 border-2 rounded-lg text-xs sm:text-xs md:text-sm font-medium flex items-center gap-1.5 sm:gap-2 transform hover:scale-110 transition-all duration-300 shadow-sm hover:shadow-md ${
                          theme === 'light'
                      ...
                      >
                        ...
                        <span className="whitespace-normal break-words">{tech}</span>
                      </span>
                    );
                  })}
                </div>
